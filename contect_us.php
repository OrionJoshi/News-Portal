...
<main role="main" class="container">
  <div class="row">
    <div class="col-md-8 blog-main">
      ...
      <div class="blog-post">
         <form class="form-horizontal" action="contect_us.php" method="post" class="needs-validation" novalidate>
          <div class="form-group">
    <label class="control-label" for="uname">Enter Your Name:</label>
    <div >
  ...
  <textarea class="form-control" name="comment" rows="5" id="comment" placeholder="Comment Us"></textarea>
</div> 
  <div class="form-group">
...
<?php
    ...
    $query3 = mysqli_query($conn,"INSERT INTO comment(name,email,comment) VALUES('$name','$email','$comment')");
